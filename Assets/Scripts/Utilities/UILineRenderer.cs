...
namespace UnityEngine.UI
{
    ...
    public class UILineRenderer : MaskableGraphic
    {
        ...
        public Vector2[] Points
        {
            get
            {
                Debug.Log("Inside get points");
                SetAllDirty(); // TODO : This needs to be changed before production. SetDirty should be called whenever the node position changes
                return m_points;
            ...
            set
            {
                Debug.Log("Inside set points");
                if (m_points == value)
                {
                    return;
                }
                Debug.Log("point value changed");
                m_points = value;
                SetAllDirty();
            }
        }
